...
16 KA=30480:NO=KA:NT=4*Q+KA:D1=8*Q+KA:D2=12*Q+KA:MT=16*Q+KA:MN=MT+Q:NP=MN+Q:XP=NP+Q:YP=XP+Q:TR=YP+Q:XR=TR+Q:YR=XR+Q:KB=KA+2251:FORI=1TO60:POKEKA-I,0:NEXTI
...
10020 POKEKB+10,SM:PRINT"INSERT INNKEEPER TAPE - PRESS PLAY - TYPE RUN":CLOAD
11000 CLS:PRINT@401,CHR$(23);"THOU ART SLAIN!":FORI=1TO2500:NEXTI:CLS:I=SQR(RND(16))+.7:ONIGOTO11010,11030,11040,11020
11010 PRINT"THOU ART EATEN":POKEKB-12,0:STOP
