...
20 C%=15360:KA=30480:Q=60:KB=KA+2251:POKE16553,255
...
1400 GOSUB4500
1500 POKEKB-12,123
1600 INPUT"ENTER DUNGEON LEVEL";LV
1605 IFPEEK(KA)=LVGOTO1670
1607 N=PEEK(KB-11)
1610 PRINT"INSERT DATA TAPE AND PRESS PLAY"
...
1665 NEXTI
1666 IFLV<>LQGOTO1620
1667 POKEKB-11,N
1670 POKEKB-12,123:PRINT"LEVEL COMPLETE - INSERT DUNJONMASTER TAPE":INPUT"PRESS PLAY AND ENTER";A$:PRINT"TYPE RUN WHEN READY IS DISPLAYED":CLOAD
1900 STOP
1950 IA=VARPTR(A$):IA=PEEK(IA+1)+256*PEEK(IA+2)
